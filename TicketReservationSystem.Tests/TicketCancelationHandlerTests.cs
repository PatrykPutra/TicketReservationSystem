...
public class TicketCancelationHandlerTests
{
    ...
    [Fact]
    public async Task TicketCancelation_ForOwnedTicket_CancelsAndReturnsSuccess()
    {
        ...
        var handler = new TicketCancelationHandler(uow.Object);
    ...
    [Fact]
    public async Task TicketCancelation_ForMissingTicket_ReturnsNotFound()
    {
        var ticketId = TicketId.CreateUnique();
    ...
    [Fact]
    public async Task TicketCancelation_ForAnotherUsersTicket_ReturnsUnauthorized()
    {
        var eventId = SocialEventId.CreateUnique();
        var ticketId = TicketId.CreateUnique();
        var ticket = CreateTicket(eventId, ticketId);
